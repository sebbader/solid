...
async function handler (req, res, next) {
  ...
  if (contentType === 'application/sparql' ||
    ...
    var end = new Date()
    evaluation.sendEval({
      "solid-server-post-started-at": start, 
      "solid-server-post-finished-at": end, 
      "solid-server-post-duration": end - start, 
      "solid-server-post-request-length": request_length, 
      "solid-server-post-response-length": response_length, 
    }) //sba
